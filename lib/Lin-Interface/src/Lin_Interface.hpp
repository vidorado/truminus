...
//
// Patched: UART driver kept open permanently (no begin()/end() per frame)
// to avoid heap fragmentation on ESP32 with repeated alloc/free cycles.
...
protected:
    ...
    bool _uartStarted = false;   // keep UART open across frames
